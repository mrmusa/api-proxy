  ...
  .done(function(response) {
    ...
    method: "GET",
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        restaurantDiv.attr("class", "col-md-12 col-md-4");

         //Creating an img tag with the restaurant images **Not appended to page yet --- different sizes
        ...
        $(function() {
          $(restaurantDiv).matchHeight({byRow: false});
        });
        $(function() {
