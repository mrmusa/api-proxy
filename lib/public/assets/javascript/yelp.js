  ...
  .done(function(response) {
    ...
    method: "GET",
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        var h2 = $("<h2>").text(name);
        // Storing the result item's rating & review count
        var rating = results[i].rating;
        var reviewCount = results[i].review_count;
        // Creating a paragraph tag with the result item's rating
        var p = $("<p>").text("Rating: " + rating + " | " + reviewCount + " reviews");
        //Creating an img tag with the Yelp branded star ratings **Still need to add this**
        ...
        restaurantDiv.append(restaurantImg,h2,p,link, p2);
